...
void setup() {
  ...
  frugal_iot.wifi->addWiFi(F("X3"),F("zaqwsxcde"));
  frugal_iot.wifi->addWiFi(F("vivo 1915"),F("lucky123"));
  frugal_iot.wifi->addWiFi(F("Stathus"),F("jlaw2423"));
  frugal_iot.wifi->addWiFi(F("realme XT"),F("12345678"));
  ...
  frugal_iot.sensors->add(new Sensor_Battery(32, 2.0)); // pin=32, voltage_divider=2.0
